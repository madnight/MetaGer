...
Das können Sie mit einer Spende auf dieser Seite tun. Oder, wenn Sie freie Suchmaschinen auch langfristig sichern wollen:
            <a href="https://metager.de/klassik/bform1.htm" target="_blank" rel="noopener">Werden Sie Mitglied im SUMA-EV</a>',
    'about.3'                   => 'Wenn Sie 100,-EUR oder mehr spenden, dann können Sie, wenn Sie wollen, auf unserer <a href="http://suma-ev.de/suma-links/index.html#sponsors" target="_blank" rel="noopener">Mitglieder- und Sponsorenseite</a> namentlich mit Link auf Ihre Homepage (sofern vorhanden) genannt werden; wenn Sie dies wünschen, vermerken Sie es bitte in Ihrer Mitteilung. <a href="https://metager.de/klassik/spenden1.html" target="_blank" rel="noopener">Oder werden Sie SUMA-EV Förderer!</a> Oder werden Sie ab 60,-EUR pro Jahr gleich Mitglied im <a href="http://suma-ev.de/" target="_blank" rel="noopener">SUMA-EV</a>, dann können Sie bis zu 6 Links auf Ihre Homepage erhalten, und Sie fördern MetaGer nachhaltig.',
    ...
    'about.5'                   => 'Eine weitere Möglichkeit, MetaGer zu fördern, besteht darin, dass Sie Ihren nächsten Online-Einkauf bei MetaGer-Fördershops machen. Damit wir auf diesem Weg unterstützt werden können, haben wir uns in das Netzwerk zur Förderung gemeinnützig anerkannter Organisationen eingebracht, das Projekt <a href="https://www.boost-project.com/de" target="_blank" rel="noopener">www.boost-project.com</a> Unter dem Dach dieses Projektes sind ca. 400 Online-Shops (von 1und1 bis Zooplus) vereint, die sich bereit erklärt haben, von allen Verkäufen etwa 6% an das Projekt zu spenden. Statt wie bisher direkt zum Online-Shop zu surfen, gehen Sie zunächst auf <a href="https://metager.de/" target="_blank" rel="noopener">MetaGer.de!</a> und klicken dort unterhalb der Suchwort-Eingabebox auf <a href="https://www.boost-project.com/de/shops?charity_id=1129&amp;tag=bl" target="_blank" rel="noopener">Machen Sie Ihre Einkäufe bei MetaGer-Fördershops - klicken Sie hier!</a> Dieser Klick führt Sie in die Shop-Auswahl des Boost-Projektes. Dort suchen Sie sich Ihren Shop aus und machen wie gewohnt Ihren Einkauf. Oder klicken Sie für Einkäufe aus dem Bereich Schreibwaren, Büro- und Geschenkartikel direkt auf <a href="https://www.gladizon.com/" target="_blank" rel="noopener">www.gladizon.com</a>. Das ist alles. Wenn genug Menschen dies tun, dann brauchen wir keine Werbung mehr. Nur zwei Mausklicks für Sie - für alle eine Chance für den freien Wissenszugang in der digitalen Welt.',
